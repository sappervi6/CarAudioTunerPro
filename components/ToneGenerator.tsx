...
import { playTone, stopAllSounds, initAudio, setFader } from '../utils/audioUtils';
...
const ToneGenerator: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Important: We DO NOT call stopAllSounds() here to allow tone to play while switching to RTA
    };
  }, []);
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-dark-card p-6 rounded-xl border border-gray-800">
           <h3 className="text-lg font-bold text-white mb-4 border-b border-gray-800 pb-2">Test Tones (60s)</h3>
